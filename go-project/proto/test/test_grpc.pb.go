...
type MessagingClient interface {
	...
	UpdateMessage(ctx context.Context, in *ReqMessage, opts ...grpc.CallOption) (*ResMessage, error)
}
...
func (c *messagingClient) UpdateMessage(ctx context.Context, in *ReqMessage, opts ...grpc.CallOption) (*ResMessage, error) {
	out := new(ResMessage)
	err := c.cc.Invoke(ctx, "/Messaging/UpdateMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MessagingServer interface {
	// Update Message Summary | This function updates a message.
	UpdateMessage(context.Context, *ReqMessage) (*ResMessage, error)
...
func (UnimplementedMessagingServer) UpdateMessage(context.Context, *ReqMessage) (*ResMessage, error) {
...
func _Messaging_UpdateMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Messaging/UpdateMessage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MessagingServer).UpdateMessage(ctx, req.(*ReqMessage))
	}
