...
func InitDB() {
	...
	GoodsData = goodsdata.MustNewGormGoodsData(db)
	if err := db.AutoMigrate(&model.Goods{}, &model.Banner{}, &model.Category{},
		&model.Brand{}, &model.CategoryBrand{}, &model.GoodsDetail{},
	); err != nil {
		panic(err)
	}
}
